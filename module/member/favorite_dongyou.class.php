...
class favorite_dongyou {
    ...
    function __construct() {
		global $db;
		$this->table = $db->pre.'favorite_dongyou';
		$this->db = &$db;
		$this->fields = array('userid','parentid','articleid','catid','addtime');
    }
	...
	function get_all($itemid){

		$itemids = is_array($itemid) ? implode(',', $itemid) : $itemid;
		return $this->db->query("SELECT * FROM {$this->table} WHERE itemid IN ($itemids)");
