...
<td><input name="category[thumb]" id="thumb" type="text" size="60" value="<?php echo $thumb;?>"/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>,<?php echo $MOD['thumb_width'];?>,<?php echo $MOD['thumb_height'];?>, Dd('thumb').value);" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview(Dd('thumb').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('thumb').value='';" class="jt">[删除]</span></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 地址<br/></td>
<td><textarea name="category[address]" cols="60" rows="3" id="address"><?php echo $address;?></textarea></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 简介<br/></td>
<td><textarea name="category[introduce]" cols="60" rows="3" id="explain"><?php echo $introduce;?></textarea></td>
</tr>
<tr>
