...
<div class="downurl">
<ul>
<li><a href="<?php echo $MOD['linkurl'];?>down.php?itemid=<?php echo $itemid;?>" class="t" rel="nofollow">主站下载</a></li>
<?php if($MIRROR) { ?>
<?php if(is_array($MIRROR)) { foreach($MIRROR as $k=>$v) { ?>
<li><a href="<?php echo $MOD['linkurl'];?>down.php?mirror=<?php echo $k;?>&itemid=<?php echo $itemid;?>" class="t" rel="nofollow"><?php echo $v['name'];?>镜像</a></li>
<?php } } ?>
<?php } ?>
</ul>
<div class="c_b"></div>
